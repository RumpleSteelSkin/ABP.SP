...
public abstract class SPWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static SPWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(SPWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<SPDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<SPDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<SPDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<SPDbContext, Task<T>> func)
    {
        T result;
